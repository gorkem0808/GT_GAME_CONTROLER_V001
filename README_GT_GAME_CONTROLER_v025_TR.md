# GT GAME CONTROLER V025 - Temiz Baştan Paket
...
- `GT_GAME_CONTROLER_v025.bat` → Programı açar
- `gt_game_controler_v025.py` → V021 tarzı renkli program
...
1. GitHub'da tercihen yeni repo aç: `GT_GAME_CONTROLER_V025`
...
5. **Build GT GAME CONTROLER V025 UF2** işini çalıştır.
...
4. Programı aç: `GT_GAME_CONTROLER_v025.bat`
...
## V025 Yenilik
- 3 dakika pasif kalma süresi artık programdan seçilebilir.
- Controller Ayar ekranındaki **Pasif süre** alanından saniye değeri girilir.
- Varsayılan 180 saniyedir.
- Örnek: 60 = 1 dakika, 180 = 3 dakika, 300 = 5 dakika.
- Coin geldikten sonra tetik her basıldığında süre yeniden başlar.
- Süre dolarsa oyuncu pasif olur, yeniden coin gerekir.
